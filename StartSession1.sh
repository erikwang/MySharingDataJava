...
java -classpath ${SOAM_HOME}/7.1.1/linux-x86_64/lib/JavaSoamApi.jar:/home/erikwang/work/MySharingDataJava711/bin com.platform.symphony.samples.SharingData.client.SharingDataClient -s SessionType1 -r 5000 -m 2 -u Admin -x Admin -c "/bin/hostname -f" -d ./api.eksymch1.log -Q false 
