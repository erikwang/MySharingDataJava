...
###################
SOAM_APP_DEP_JARFILES=$SOAM_DEPLOY_DIR/AnotherMySampleAppServiceJava.jar

###################
# 3. This is the main class used to start the Application code.
###################
SOAM_SERVICE_MAINCLASS=com.platform.symphony.samples.SampleApp.anotherservice.MyService
