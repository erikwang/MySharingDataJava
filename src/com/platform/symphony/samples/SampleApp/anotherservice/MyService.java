...
package com.platform.symphony.samples.SampleApp.anotherservice;
...
public class MyService extends ServiceContainer
{
    ...
    public void onInvoke (TaskContext taskContext) throws SoamException
    {
        ...
        sb.append("[Another Sample Service]Client sent : ");
        sb.append(myInput.getString());
        sb.append("\n[Another Sample Service] - By listening a voice from client, Symphony replied : Hello Client !!");
